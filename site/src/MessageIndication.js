class MessageIndication extends React.Component {
    ...
    async componentDidMount() 
    {
        ...
        this.intervalId = setInterval( () => { this.check_for_new_messages() }, 3000 );    
    }
    ...
    render() {
        return (
            <div className="new_message_label">
                <button className="new_message_button" onClick={this.handle_new_message_recived}>new Messages counter: {this.state.messages_counter_diff}</button>
            </div>
        );
    }
}
